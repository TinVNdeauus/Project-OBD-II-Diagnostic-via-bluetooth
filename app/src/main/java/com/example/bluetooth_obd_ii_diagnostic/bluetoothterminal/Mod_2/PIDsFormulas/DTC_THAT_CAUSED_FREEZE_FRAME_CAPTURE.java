package com.example.bluetooth_obd_ii_diagnostic.bluetoothterminal.Mod_2.PIDsFormulas;

public class DTC_THAT_CAUSED_FREEZE_FRAME_CAPTURE {
    ...
    public static String read(String firstHex, String secondHex) {
        ...
        if (secondByteLine.substring(4, 8).equals("1111")) DTC_5 = "F";
          ...
          String response = "Diagnostic Trouble Code (DTC) that caused Freeze Frame capture:  "  + DTC + " \n";
