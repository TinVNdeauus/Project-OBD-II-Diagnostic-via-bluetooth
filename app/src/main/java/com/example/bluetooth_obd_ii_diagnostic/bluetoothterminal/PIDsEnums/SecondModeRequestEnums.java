...
import java.util.Map;
    ...
    public enum SecondModeRequestEnums {
        PIDs_SUPPORTED_01_20("00"),
        MONITOR_STATUS_SINCE_DTCs_CLEARED("01"),             //first mode only
        DTC_THAT_CAUSED_FREEZE_FRAME_CAPTURE("02"),          //second mode only
        ...
        static {
            for (SecondModeRequestEnums enums : SecondModeRequestEnums.values())
                methodMap.put(enums.getValue(), enums);
        }

        private final String value;

        SecondModeRequestEnums(String value) {
            this.value = value;
        }
