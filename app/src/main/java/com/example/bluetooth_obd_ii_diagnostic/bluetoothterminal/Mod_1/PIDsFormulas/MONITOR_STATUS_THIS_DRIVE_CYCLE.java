...
public class MONITOR_STATUS_THIS_DRIVE_CYCLE {
    ...
    public static String read(String secondHex, String thirdHex, String fourthHex) {
        ...
        /**
         * First byte is always zero in this PID
         */
        ...
        String response = "\nMonitors status in this drive cycle: \n"
