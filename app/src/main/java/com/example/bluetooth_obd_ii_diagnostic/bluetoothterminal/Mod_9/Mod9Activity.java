...
public class Mod9Activity extends AppCompatActivity {
    private final String DEVICE_ADDRESS = "00:00:00:00:11:11";
    private final UUID PORT_UUID = UUID.fromString("00001101-0000-1000-8000-00805f9b34fb");//Serial Port Service ID
    private final String MOD_9_PREFIX = "49";
    private final String VIN_PREFIX = "014";
    private final String CID_PREFIX = "013";
    private final String IPT_PREFIX = "02B";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mod_9_activity);
        startButton = (Button) findViewById(R.id.buttonStart);
        sendButton = (Button) findViewById(R.id.buttonSend);
        clearButton = (Button) findViewById(R.id.buttonClear);
        stopButton = (Button) findViewById(R.id.buttonStop);
        textView = (TextView) findViewById(R.id.textView);
        MOD_9_LIST = (Spinner) findViewById(R.id.mod9list);

        ArrayAdapter<NinthModeRequestEnums> myAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, NinthModeRequestEnums.values());
        myAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        MOD_9_LIST.setAdapter(myAdapter);
                ...
                while (!Thread.currentThread().isInterrupted() && !stopThread) {
                    try {
                        ...
                        if (byteCount > 0) {
                            ...
                            if (rawResponse.startsWith(MOD_9_PREFIX)||rawResponse.startsWith(VIN_PREFIX)
                              ||rawResponse.startsWith(CID_PREFIX)||rawResponse.startsWith(IPT_PREFIX)) {
                                final String response = MOD9ResponseCalculator.MOD9ResponseCalculator(rawResponse);
    ...
    public void onClickSend(View view) {
        String PID = MOD_9_LIST.getSelectedItem().toString();
        String requestPID = "09" + NinthModeRequestEnums.valueOf(PID).getValue();
        requestPID.concat("\n");
        try {
